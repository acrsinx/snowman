...
public partial class SnowCover: MeshInstance3D {
    ...
    public void Stamp(Node3D character, float x, float y) {
        ...
        snowmanStamp.Multimesh.SetInstanceTransform2D(0, new Transform2D(MathF.Atan2(y, x), player.ui.settingPanel.gameInformation.SnowCoverSize / size * new Vector2(character.GlobalPosition.X, character.GlobalPosition.Z))
        .ScaledLocal(Tool.Vector2(0.06f*player.ui.settingPanel.gameInformation.SnowCoverSize/size)));
    }
